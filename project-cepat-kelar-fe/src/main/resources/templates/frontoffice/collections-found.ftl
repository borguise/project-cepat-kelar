    ...
    <div id="kios-canvas">
        ...
        <div id="filterModal">
            <div class="OverlayFilter" id="filterBox">
                ...
                <form id="filterForm" action="${searchAction!"/collections"}" method="GET">
                    ...
                    <#if bookList?? && bookList?size gt 0>
                        <#list bookList as book>
                            <div class="flex flex-col items-center">
                                <img src="${book.cover!"/images/frontoffice/baris1.png"}" class="w-full aspect-[2/3] rounded-2xl object-cover mb-6 border border-zinc-100">
