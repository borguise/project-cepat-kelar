...
<head>
    ...
    <style>
        ...
        /* --- HOTSPOT & ANIMASI (DISEMPURNAKAN - GOLDEN GLOW) --- */
        @keyframes heartbeatGlow {
            0%, 100% { 
                /* Pendaran tipis keemasan */
                filter: drop-shadow(0 0 8px rgba(255, 215, 0, 0.3)); 
            } 
            50% { 
                /* Pendaran menyebar lebih lebar, warna emas hangat */
        ...
        .hotspot { 
            ...
            /* Animasi lebih cepat agar terasa 'hidup' (1.8s) */
            animation: heartbeatGlow 1.8s infinite ease-in-out; 
        }
        
        .hotspot:hover { 
            transform: scale(1.04); 
            /* Cahaya emas stabil saat disentuh */
        ...
        .overlay-container { width: 90%; max-width: 800px; height: 85vh; background: #F7F3EE; border-radius: 30px; position: relative; overflow: hidden; display: none; flex-direction: column; border: 2px solid #3B5998; }
        .close-overlay { position: absolute; top: 20px; right: 20px; width: 45px; height: 45px; background: #3B5998; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 100; font-size: 20px; font-weight: bold; }
