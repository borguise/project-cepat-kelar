...
<body>
    ...
    <div id="homepage-canvas">
        ...
        <button class="hotspot w-[992px] h-[502px] left-[75px] top-[152px] layer-furnitur" onclick="location.href='${koleksiUrl! '/collections'}'">
            <img src="${basePath}/rak2.png" alt="Rak Atas" decoding="async">
        </button>

        <#-- 2. LIFT (Navigasi Beranda & Anti-Mengambang) -->
        <button class="hotspot w-[384px] h-[600px] left-[86px] top-[815px] layer-furnitur" onclick="location.href='${berandaUrl! '/home'}'">
        ...
        <button class="hotspot w-[488px] h-[647px] left-[499px] top-[765px] layer-furnitur" onclick="location.href='${audioUrl! '/audio'}'">
        ...
        <#-- Hotspots Lainnya -->
        <button class="hotspot w-[676.20px] h-[518.65px] left-[301px] top-[1181px] layer-furnitur" onclick="location.href='${fasilitasUrl! '/facilities'}'">
            <img src="${basePath}/meja2.png" alt="Area Baca" decoding="async">
        </button>
        <button class="hotspot w-[240px] h-[384px] left-[857px] top-[1555px] layer-furnitur" onclick="location.href='${pemilihanUrl! '/voting'}'">
