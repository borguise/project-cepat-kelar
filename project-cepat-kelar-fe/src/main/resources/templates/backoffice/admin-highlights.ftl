              ...
              <tr class="hover:bg-slate-50/80 transition-colors duration-200 h-20">
                ...
                <td class="px-6 py-4">
                  <div class="flex justify-center gap-4 text-sm font-semibold">
                    <a href="/admin/highlights/edit/${item.id}" class="text-indigo-600 hover:text-indigo-800 transition">Edit</a>
                    <a href="/admin/highlights/delete/${item.id}" onclick="return confirm('Hapus data ini?')" class="text-red-500 hover:text-red-700 transition">Hapus</a>
                  </div>
                </td>
              </tr>
            </#list>
