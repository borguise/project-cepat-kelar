      ...
      <div class="w-full max-w-6xl mx-auto bg-white rounded-3xl shadow-[0px_10px_30px_rgba(243,237,237,1.0)] border border-stone-100 overflow-hidden mb-12">
                ...
                <tr class="hover:bg-slate-50 transition h-20">
                  ...
                  <td class="px-4">
                    <div class="flex justify-center gap-3 text-xs font-semibold py-2">
                      <a href="/admin/voting/edit/${vote.id}" title="Edit" class="hover:scale-125 transition">Edit</a>
                      <a href="/admin/voting/result/${vote.id}" title="Lihat Hasil" class="hover:scale-125 transition">View</a>
                      <form action="/admin/voting/delete/${vote.id}" method="POST" onsubmit="return confirm('Hapus pemilihan ini?')">
                        <button type="submit" title="Hapus" class="hover:scale-125 transition text-red-400">Delete</button>
                      </form>
                    </div>
                  </td>
                </tr>
        ...
        <div class="px-12 py-8 bg-slate-50 border-t border-black/10 flex justify-between items-center text-slate-500">
            ...
            <div class="flex gap-4 items-center">
                <button class="hover:text-indigo-600 font-bold transition text-sm">Prev</button>
                ...
                <button class="hover:text-indigo-600 font-bold transition text-sm">Next</button>
            </div>
        </div>
      </div> 
