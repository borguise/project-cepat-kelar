...
<#if isAdminError>
  ...
  <@layout.backofficeLayout title="404 - Halaman Tidak Ditemukan" activePage=activePage adminName=(adminName!"Pustakawan")>
    <div class="w-full max-w-5xl mx-auto">
      <div class="bg-white rounded-3xl border border-red-200 shadow-md p-8 md:p-10">
        <div class="inline-flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg px-4 py-2 mb-5">
          <span class="text-red-700 font-bold">Error 404</span>
        </div>

        <h2 class="font-gelasio text-4xl text-slate-900 mb-3">Halaman Tidak Ditemukan</h2>
        <p class="text-slate-600 text-lg mb-8">${message!"Halaman yang Anda cari tidak tersedia atau sudah dipindahkan."}</p>
...
<@err.fallbackErrorPage
  ...
  errorMessage=(message!"Halaman yang Anda cari tidak tersedia atau sudah dipindahkan.")
  path=requestPath
  timestamp=(timestamp!"-")
/>
</#if>
