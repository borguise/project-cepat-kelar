...
<head>
    ...
    <style>
        ...
        #canvas::before {
            ...
            background-image: url('${texturePath!"tekstur-kertas.jpg"}'); 
    ...
    <div id="canvas">
        ...
        <header class="w-full pt-40 px-20 flex items-center">
            ...
            <div class="w-32 h-32 flex items-center justify-center overflow-hidden">
                <img src="${logoPath!"logo.png"}" alt="Logo" class="w-full h-full object-contain mix-blend-multiply">
            </div>
        ...
        <footer class="pb-80 flex justify-center">
            <a href="${content.buttonUrl!"beranda.html"}" 
