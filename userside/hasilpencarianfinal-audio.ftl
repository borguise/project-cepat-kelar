<#-- 
  Variabel dari Backend Java:
  - keyword: Kata kunci yang dicari (String)
  - tracks: Daftar hasil rekaman (List<Track>)
  - fJudul, fPenerbit, fIsbn, fPenulis: Status filter (Boolean)
-->
...
<body>
    ...
    <div id="kios-canvas">
        ...
        <div class="top-bar-container">
            <form action="/hasilpencarianfinal-audio" method="GET" class="search-form">
        ...
        <div class="content-card">
            ...
            <#if tracks?? && (tracks?size > 0)>
                ...
                <div class="result-grid">
                    ...
                    <div class="audio-item" onclick="location.href='/audio/player?id=${track.id}'">
                        <div class="vinyl-record"><div class="vinyl-dot"></div></div>
                        <div class="flex flex-col gap-2">
                            <span class="font-bold text-2xl">${track.title}</span>
                            <span class="text-xl text-slate-600">${track.description!""}</span>
                        </div>
                    </div>
                    </#list>
                </div>
        ...
        <div id="filterModal">
            <div class="filter-card">
                ...
                <form action="/hasilpencarianfinal-audio" method="GET">
