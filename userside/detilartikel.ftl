            ...
            <div class="results-wrapper">
                <div class="grid grid-cols-3 gap-8">
                    <div class="flex flex-col items-center">
                        <img src="baris1.png" class="w-full aspect-[2/3] rounded-2xl object-cover mb-6 border border-zinc-100">
                        <p class="book-title-indigo text-xl text-center leading-snug px-1">Para Penyala cahaya dari Lereng Gunung Lawu</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <img src="baris2.png" class="w-full aspect-[2/3] rounded-2xl object-cover mb-6 border border-zinc-100">
                        <p class="book-title-indigo text-xl text-center leading-snug px-1">Antara Lawu dan Wilis</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <img src="baris3.png" class="w-full aspect-[2/3] rounded-2xl object-cover mb-6 border border-zinc-100">
