...
<body>
    ...
    <div id="homepage-canvas">
        ...
        <#-- 1. TOTEM HIGHLIGHT -->
        <button class="hotspot totem-btn w-[198px] h-[531px] left-[30px] top-[1300px]" onclick="location.href='${infoUrl! 'sorotan.html'}'">
        ...
        <button class="hotspot w-96 h-60 left-[305px] top-[1468px]" onclick="location.href='${layananUrl! 'layanan.html'}'"><img src="${basePath}/meja.png" alt="Meja" decoding="async"></button>
        <button class="hotspot w-72 h-64 left-[305px] top-[1203px]" onclick="location.href='${eventUrl! 'agenda.html'}'"><img src="${basePath}/kalender.png" alt="Kalender" decoding="async"></button>
        <button class="hotspot w-48 h-72 left-[635px] top-[1320px]" onclick="location.href='${lantaiUrl! 'beranda2.html'}'"><img src="${basePath}/lift.png" alt="Lift" decoding="async"></button>
        <button class="hotspot w-48 h-40 left-[861px] top-[1281px]" onclick="location.href='${galeriUrl! 'profil.html'}'"><img src="${basePath}/figura.png" alt="Figura" decoding="async"></button>
        <button class="hotspot w-80 h-80 left-[825px] top-[1427px]" onclick="location.href='${beritaUrl! 'berita.html'}'"><img src="${basePath}/troli.png" alt="Troli" decoding="async"></button>
    </div>
