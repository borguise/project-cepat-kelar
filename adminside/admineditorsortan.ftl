...
<body class="bg-[#f8fafc]">
  ...
  <aside class="w-60 bg-[#1e293b] text-stone-300 flex flex-col h-full flex-shrink-0 shadow-2xl z-50 rounded-br-2xl text-lg">
  ...
  <main class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <div class="flex-1 overflow-y-auto p-12 bg-slate-50/50 flex flex-col gap-10 scroll-indah">      
      ...
      <form action="/admin/sorotan/simpan" method="POST" class="w-full max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-12 flex flex-col gap-8 mb-20 border border-stone-100">
